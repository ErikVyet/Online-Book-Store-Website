...
<head>
    ...
    <link rel="stylesheet" href="./resource/css/categoryDetailEditForm.css">
    <script src="./resource/js/categoryDetailEditForm.js"></script>
...
%>
	<div class="container">
        ...
        <main>
            <form class="form-container" action="./category?action=update" method="post">
                <div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/name.png"> ID</label>
                        <input name="id" type="text" value="<%=category.getId()%>" required readonly>
                    </div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/name.png"> Name</label>
                        <input name="name" type="text" value="<%=category.getName()%>" required readonly>
                    </div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/description.png"> Description</label>
                        <textarea name="description" readonly><%=category.getDescription()%></textarea>
                    </div>
                </div>
                <div>
                    ...
                    <a id="btnBack" href="./categories.jsp">Back</a>
                </div>
            </form>
        </main>
        <footer>
