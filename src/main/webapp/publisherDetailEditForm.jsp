...
<head>
    ...
    <link rel="stylesheet" href="./resource/css/publisherDetailEditForm.css">
    <script src="./resource/js/publisherDetailEditForm.js"></script>
...
%>
	<div class="container">
        ...
        <main>
            <form class="form-container" action="./publisher?action=update" method="post">
                <div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/id.png"> ID</label>
                        <input name="id" type="text" value="<%=publisher.getId()%>" autocomplete="off" required readonly>
                    </div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/name.png"> Name</label>
                        <input name="name" type="text" value="<%=publisher.getName()%>" autocomplete="off" required readonly>
                    </div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/address.png"> Address</label>
                        <input name="address" type="text" value="<%=publisher.getAddress()%>" autocomplete="off" required readonly>
                    </div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/phone.png"> Phone</label>
                        <input name="phone" type="tel" maxlength="11" value="<%=publisher.getPhone()%>" autocomplete="off" required readonly>
                    </div>
                    <div class="form-input-group">
                        <label><img src="./resource/image/email.png"> Email</label>
                        <input name="email" type="text" value="<%=publisher.getEmail()%>" autocomplete="off" required readonly>
                    </div>
                    <div></div>
                </div>
                <div>
                    ...
                    <a id="btnBack" href="./publishers.jsp">Back</a>
                </div>
            </form>
        </main>
        <footer>
